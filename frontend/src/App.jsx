      ...
      <main>
        ...
        <div className="main-content">
          ...
          <section className="connect-panel" ref={connectRef} aria-label="Wallet connection">
            ...
            {import.meta.env.DEV && <div className="demo-switch"><span>Try a seeded demo:</span>{['Alice', 'Bob', 'Carol'].map((name, i) => <button key={name} disabled={connecting || frozen || session?.name === name} onClick={() => connect(['demo-alice-token-0001', 'demo-bob-token-000001', 'demo-carol-token-0001'][i], name)}>{name}</button>)}<small>Switching clears this session’s activity.</small></div>}
          </section>
